    ...
    with open(file_name, 'r') as f:
        for line_in_file in f:
            ...
            if word_to_search in line_in_file:
                yield "{}: {}".format(string_number, line_in_file if len(line_in_file) <= 68 else "{}{}".format(line_in_file[:68], "...")) 
                
# Implementation with usage of Python's features
def file_processing_with_more_python_features(file_name = "TCP_IP.txt", word_to_search="TCP"):
    with open(file_name, 'r') as f:
