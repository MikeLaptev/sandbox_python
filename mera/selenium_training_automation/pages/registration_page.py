...
class RegistrationPage(Page):
    ...
    def __init__(self, driver, url):
        ...
        self.input_container_xpath = (
            "//form[@id='info-form']/div[@class='input-container']"
        )
        ...
        self.validation_message_xpath = (
            self.input_container_xpath + "//p[contains(@class, 'validation-message')]"
        )
    ...
    def select_country_code(self, country_code):
        ...
        country_code_containers = self.input_container.find_element_by_id(
            "country-codes-menu-1"
        )
        country_code_element = country_code_containers.find_element_by_xpath(
            ".//a[@data-code='{}']".format(country_code)
        )
        webdriver.ActionChains(self.driver).move_to_element(
            country_code_element
        ).click().perform()
    ...
    def submit_button(self):
        return self.input_container.find_element_by_css_selector(
            ".button.submit.btn-purple"
        )
    ...
    def is_name_validation_message_visible(self):
        return self.is_element_visible_by_locator(
            (By.ID, self.name_validation_message_id)
        )

    # Username or email
    @property
    def username_validation_message(self):
        return self.input_container.find_element_by_id(
            self.username_validation_message_id
        )

    @property
    def is_username_validation_message_visible(self):
        return self.is_element_visible_by_locator(
            (By.ID, self.username_validation_message_id)
        )
    ...
    def password_validation_message(self):
        return self.input_container.find_element_by_id(
            self.password_validation_message_id
        )

    @property
    def is_password_validation_message_visible(self):
        return self.is_element_visible_by_locator(
            (By.ID, self.password_validation_message_id)
        )
    ...
    def mobile_validation_message(self):
        return self.input_container.find_element_by_id(
            self.mobile_validation_message_id
        )

    @property
    def is_mobile_validation_message_visible(self):
        return self.is_element_visible_by_locator(
            (By.ID, self.mobile_validation_message_id)
        )
    ...
    def day_of_birth_validation_message(self):
        return self.input_container.find_element_by_id(
            self.day_of_birth_validation_message_id
        )

    @property
    def is_day_of_birth_validation_message_visible(self):
        return self.is_element_visible_by_locator(
            (By.ID, self.day_of_birth_validation_message_id)
        )
    ...
    def gender_validation_message(self):
        return self.input_container.find_element_by_id(
            self.gender_validation_message_id
        )

    @property
    def is_gender_validation_message_visible(self):
        return self.is_element_visible_by_locator(
            (By.ID, self.gender_validation_message_id)
        )

    # Validation message box
    @property
    def validation_message_boxes(self):
        return self.input_container.find_elements_by_xpath(
            self.validation_message_xpath
        )
