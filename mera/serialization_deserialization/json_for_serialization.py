...
class JSON_Serialization(Base_Serialization):
    ...
    def serialize_object(self, object_to_serialize):
        try:
            ...
            print(
                (
                    "Object '{}' is not JSON serializable: {}{}".format(
                        object_to_serialize.__class__.__name__, os.linesep, te
                    )
                )
            )
    ...
    def deserialize_object(self, type_of_serialized_object):
        try:
            ...
            print(
                (
                    "Object '{}' could not be decoded after serialization: {}{}".format(
                        type_of_serialized_object, os.linesep, ve
                    )
                )
            )
